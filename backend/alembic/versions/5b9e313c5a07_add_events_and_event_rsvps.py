...
def upgrade() -> None:
    ...
    sa.Column('vehicle_type', sa.Enum('ADVENTURE', 'FOUR_STROKE', 'TWO_STROKE', 'DUAL_SPORT', 'MOTOCROSS', 'OTHER', name='vehicletype', create_type=False), nullable=True),
    sa.Column('difficulty', sa.Enum('EASY', 'MODERATE', 'HARD', 'EXTREME', name='difficulty', create_type=False), nullable=True),
